...
class MeshGraphNet(Module):
    ...
    def forward(
        ...
        # Car Graph nodes feature
        # torch.Size([68012, 11])
        # 11 for ['pos', 'velocity', 'reynolds_number', 'length', 'width', 'height', 'ground_clearance', 'slant_angle', 'fillet_radius']
        # 11 for ['p', 'wallShearStress']

        edge_features: Tensor,
        # Car Graph edge feature, bidirected
        # torch.Size([269226, 4])
        # 3 for disp.shape torch.Size([269226, 3])
        # 1 for disp.norm
